...
class Add(Resource):
    def post(self):
    	...
    	updateAccount(username, money+bank_cash)
...
class Transfert(Resource):
    def post(self):
    	...
    	updateAccount("BANK", bank_cash+1)
    	updateAccount(to, money + bank_cash - 1)
    	updateAccount(username, cash_from-bank_cash)
...
class PayLoan(Resource):
    def post(self):
    	...
    	if cash < money :
    		return jsonify(generateReturnDictionary(300, "Not enough cash in your account"))
...
api.add_resource(Transfert, '/transfert')
